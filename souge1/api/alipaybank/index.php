            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input name="WIDseller_email" value="dd885net@sina.com" size="30" />
                        <span>必填
</span>
                  </dd>
                    <dt>商户订单号：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input name="WIDout_trade_no" value="1000000000" size="30" />
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input name="WIDsubject" value="汽车用品" size="30" />
                        <span>必填
</span>
                  </dd>
                    <dt>付款金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input name="WIDtotal_fee" value="0.01" size="30" />
                        <span>必填
</span>
                  </dd>
                    <dt>订单描述
：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input name="WIDbody" value="商品+安装" size="30" />
                        <span></span>
                  </dd>
                    <dt>默认网银：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input name="WIDdefaultbank" value="ICBCB2C" size="30" />
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input name="WIDshow_url" value="http://localhost/aipute_2012" size="30" />
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input name="WIDexter_invoke_ip" value="8.8.8.8" size="30" />
                        <span>非局域网的外网IP地址，如：221.0.0.1</span>
                  </dd>
					<dt></dt>
                    <dd>
