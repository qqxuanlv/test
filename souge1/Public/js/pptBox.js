...
function show_kinga_list(f,l)
{
	...
	function GotoPosition(id,obj) { 

var position = document.getElementById("list_" + id);
 var top = GetElementTop(position)-0;
 window.scrollTo(0, top);
 //obj.style.color = "red";
 $("#fix a").removeClass("on");
 $("#letter"+id).addClass("on");
}
